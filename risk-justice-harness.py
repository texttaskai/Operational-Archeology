...
JUSTICE_PATH = "risk-justice-0.2.json"
CASES_PATH = "risk-justice-cases-0.2.json"
...
def validate_legal_states(justice, cases):
    return oa_capsule.validate_legal_states(
        justice,
        cases,
...
def validate_fixture_consistency(cases, justice):
    return oa_capsule.validate_fixture_consistency(
        cases,
        justice["capsule_contract"],
    )
...
def main():
    ...
    validate_fixture_consistency(cases, justice)
