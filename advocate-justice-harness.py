...
JUSTICE_PATH = "advocate-justice-0.2.json"
CASES_PATH = "advocate-justice-cases-0.2.json"
...
def self_test_reasoning_output_validator(output_contract):
    legal_output = {
        "position": "Synthetic Advocate validator self-test.",
    }
...
def main():
    ...
    print("ADVOCATE JUSTICE LOAD: PASS")
